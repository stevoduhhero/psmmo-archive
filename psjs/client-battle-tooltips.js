var BattleTooltips = (function () {
	...
	BattleTooltips.showTooltipFor = function (roomid, thing, type, elem, ownHeight) {
		vars.rooms[roomid].tooltips.showTooltip(thing, type, elem, ownHeight);
	};
	...
	BattleTooltips.prototype.tooltipAttrs = function (thing, type, ownHeight) {
		...
		var isActive = true;
		return ' onmouseover="BattleTooltips.showTooltipFor(\'' + roomid + '\', \'' + Tools.escapeHTML(''+thing, true) + '\',\'' + type + '\', this, ' + (ownHeight ? 'true' : 'false') + ', ' + (isActive ? 'true' : 'false') + ')"' +
		' onmouseout="BattleTooltips.hideTooltip();"' +
		' onmouseup="BattleTooltips.hideTooltip();"';
	};
